...
/*
  ...
  das linhas e a média dos valores pares das colunas da matriz ma(N,M). Escreva os vetores de 
  maneira que o usuário consiga interpretar seu conteúdo adequadamente;
